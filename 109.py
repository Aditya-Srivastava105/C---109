...
print("Standard_Deviation of data is {}".format(std_deviation))

print("{}% of data lies within 1st standard_deviation", format(len(list_of_data_within_1_std_deviation)*100.0/len(data)))
print("{}% of data lies within 2nd standard_deviation", format(len(list_of_data_within_2_std_deviation)*100.0/len(data)))
print("{}% of data lies within 3rd standard_deviation", format(len(list_of_data_within_3_std_deviation)*100.0/len(data)))